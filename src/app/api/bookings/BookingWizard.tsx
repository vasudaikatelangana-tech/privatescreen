...
const TIME_SLOTS = [
  { id:"t1", time:"10:00 AM", label:"Morning",  emoji:"☀️",  available:true  },
  { id:"t2", time:"1:00 PM",  label:"Afternoon", emoji:"🌤️", available:true  },
  { id:"t3", time:"4:00 PM",  label:"Evening",   emoji:"🌇", available:false },
  { id:"t4", time:"7:00 PM",  label:"Night",     emoji:"🌙", available:true  },
  { id:"t5", time:"10:00 PM", label:"Late Night",emoji:"🌃", available:true  },
];
